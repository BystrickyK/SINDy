...
filename = dirname + 'simdata_full.csv'
...
trig_bilinears = product_library(trig_data, pd.concat((state_data.loc[:, ('x_4')],
...
codegen(('identified_model', symeqns),
        argument_sequence=['x1', 'x2', 'x3', 'x4', 'u'],
